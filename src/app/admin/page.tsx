    ...
    try {
      ...
      if (dbMesas && dbMesas.length > 0) {
        ...
        const sampleAsistentes = [
          { nombre: 'Carlos Mendoza', cedula: '12345678', telefono: '04141234567', condominio: 'Residencias El Faro', municipio: 'Mariño', mesa_preasignada_id: m1 },
          { nombre: 'María Rodríguez', cedula: '87654321', telefono: '04249876543', condominio: 'Villa Colonial', municipio: 'Maneiro', mesa_preasignada_id: m2 },
          { nombre: 'Juan Pérez', cedula: '11223344', telefono: '04125556677', condominio: 'Edificio Solymar', municipio: 'Mariño', mesa_preasignada_id: m3 },
          { nombre: 'Ana Gómez', cedula: '44332211', telefono: '04168889900', condominio: 'Conjunto Residencial La Selva', municipio: 'García', mesa_preasignada_id: m4 },
          { nombre: 'Pedro Martínez', cedula: '15975312', telefono: '04147778899', condominio: 'Residencias Coral', municipio: 'Maneiro', mesa_preasignada_id: m5 },
          { nombre: 'Sofía Castro', cedula: '99887766', telefono: '04246665544', condominio: 'Lomas del Viento', municipio: 'Mariño', mesa_preasignada_id: m6 },
        ];
